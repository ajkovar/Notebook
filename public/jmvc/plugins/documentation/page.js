 ...
 * @codeend
 */
include.Doc.Pair.extend('include.Doc.Page',
/* @Static */
{
    starts_scope: true,
    listing: [],
    ...
    init : function(){
        this.add(
        include.Doc.Directive.CodeStart, include.Doc.Directive.CodeEnd, include.Doc.Directive.Tag)
...
/* @Prototype */
{
    ...
    toFile : function(name){
        try{
            ...
            new include.File('apps/'+name+'/docs/'+this.name.replace(/ /g,"_")+".json").save(res);
