...
<pre>
[include.Doc.Function|@function] <i>function_name</i>                       -> Forces a function
[include.Doc.Directive.Param|@param] {<i>optional:type</i>} <i>param_name</i> <i>Description</i> -> Describes a parameter
[include.Doc.Directive.Return|@return] {<i>type</i>} <i>Description</i>                    -> Describes the return value
</pre>
 * Add <i>optional:</i> for optional params.  Other available directives: 
 * [include.Doc.Directive.Plugin|@plugin],[include.Doc.Directive.CodeStart|@codestart]
 * <h3>Example</h3>
@codestart
...
@codeend
 */
include.Doc.Pair.extend('include.Doc.Function',
/* @static */
{
    code_match: /(?:([\w\.]+)|(["'][^"']+["']))\s*[:=]\s*function\(([^\)]*)/,
    init : function(){
        this.add(include.Doc.Directive.Return, include.Doc.Directive.Param, include.Doc.Directive.CodeStart, 
        include.Doc.Directive.CodeEnd,include.Doc.Directive.Plugin, include.Doc.Directive.Hide, 
        include.Doc.Directive.Tag)
        this._super();
    }
},
/* @prototype */
