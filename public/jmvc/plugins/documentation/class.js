 ...
 * include Doc can automatically detect classes created with jQuery.Class.  However, you can make anything
 ...
 * @codeend
 */
include.Doc.Pair.extend('include.Doc.Class',
/* @Static */
{
     ...
     */
    init : function(){
        this.add(include.Doc.Directive.Inherits, 
        include.Doc.Directive.Author,
        include.Doc.Directive.Hide,
        include.Doc.Directive.CodeStart, include.Doc.Directive.CodeEnd, include.Doc.Directive.Alias,
...
/* @Prototype */
{
     ...
     * @param {include.Doc.Pair} scope where the class was created, typically the file
     */
