 ...
 * JavaScript testing suite you've come to the right place!  <br/><br/>
 * 
 * Test's tiered approach gives you the best combination of coverage, ease of use, and speed
 * of any library.  You write one set of tests and they can run in several contexts - the 
 * browser, Rhino, and Selenium.<br/><br/>
 * Features:
 * <ul>
 ...
 * </ul>
 * All of these features are tightly integrated and available by default in 
 * every JavaScriptMVC application. You get them all for free.
...
@codeend
    ...
    timeout : function(fname, delay){
          ...
          setTimeout(this._make_callback(fname, args), delay*1000)
    },
    /**
    ...
    timeoutCallback : function(fname, timeout){
        ...
        timer = setTimeout(function(){
            ret.failed = true;
            inst.error("callback not called in time!");
            inst._delays--;
            inst._update();
        }, timeout)
