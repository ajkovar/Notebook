 ...
 *
 *       this.validatesFormatOf('due_date', /^[0-9]{4}-(((0[13578]|(10|12))-(0[1-9]|[1-2][0-9]|3[0-1]))|(02-(0[1-9]|[1-2][0-9]))|((0[469]|11)-(0[1-9]|[1-2][0-9]|30)))$/);
 *
 ...
 * will return false.  The [jQuery.Model.prototype.getErrors|getErrors] function can be used to retrieve the
 * list of errors.
 */
(function($) {
...
$.extend($.Model.prototype, {
   ...
   /**
    * Returns a list of attributes that failed validation
   ...
   /**
    * Returns the error messages for a given attribute
