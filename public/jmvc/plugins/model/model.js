...
/* @Static*/
{
    ...
    wrap : function(attributes){
        ...
        //if(jQuery.Controller) jQuery.Controller.publish(this.className + ":createAsExisting", );
    ...
    publish : function(event, data){
        OpenAjax.hub.publish(   this.fullName + "."+event, data);
    },
    /**
...
{   
     ...
     */
    updateAttrs : function(attributes, success, error)
    {
        this.attrs(attributes);
    ...
    */
    ...
    _setProperty : function(property, value) {  
        if(this["set"+jQuery.String.capitalize(property)] && ! this["set"+jQuery.String.capitalize(property)](value) ){
            return;
        }
        ...
        this[property] = property == 'created_at' || property == 'updated_at' ? MVC.Date.parse(value) :  value;
        ...
        this.Class.addAttr(property, this.Class.guessType(value)  );
    },
     ...
     */
    isNew : function(){ return typeof this[this.Class.id] == 'undefined'; },
    /**
     * Saves the instance
    ...
    save: function(success,error){
        ...
        result = this.isNew() ? 
            this.Class.create(this.attrs(), success, error) : 
            this.Class.update(this[this.Class.id], this.attrs(), success, error);
...
jQuery.fn.models = function(){
  	var models = arguments.length ? jQuery.makeArray(arguments) : jQuery.Model.models
